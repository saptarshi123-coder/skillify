      ...
      <main className="w-full max-w-[440px] bg-surface-container-lowest dark:bg-surface-container-high rounded-[28px] p-6 md:p-8 shadow-[0_12px_32px_rgba(154,0,2,0.08)] flex flex-col items-center relative overflow-hidden border border-outline-variant/30">
        ...
        <div className="w-full flex flex-col gap-3 mb-6">
          ...
          <button
            ...
            className="group relative w-full flex items-center justify-center gap-3 py-3 px-5 rounded-full border-[1.5px] border-[#0A66C2]/40 hover:border-[#0A66C2] bg-[#0A66C2]/5 dark:bg-[#0A66C2]/15 text-[#0A66C2] dark:text-[#70b5f9] hover:bg-[#0A66C2]/10 transition-all duration-300 transform hover:-translate-y-[2px] shadow-sm font-label-md text-sm font-bold active:scale-[0.99] cursor-pointer"
          >
            <svg className="w-5 h-5 fill-current shrink-0" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
            <span>{isSignUp ? "Sign up with LinkedIn" : "Continue with LinkedIn"}</span>
          </button>
