            ...
            <div className="flex gap-2 pt-1">
              {presetAvatars.map((p, idx) => (
                <div
                  ...
                  className={`w-8 h-8 rounded-full overflow-hidden border-2 cursor-pointer transition-all ${avatar === p.url ? 'border-primary ring-2 ring-primary/30 scale-110' : 'border-transparent opacity-70 hover:opacity-100'
                    }`}
                  title={p.label}
                >
